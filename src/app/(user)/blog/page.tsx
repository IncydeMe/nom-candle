...
function Blog() {
    return (
            <main className=''>
                <Image src={Blog_Cover} alt="Blog Cover Image" className="w-[100%] h-[360px] object-cover rounded-[12px]" />
                ...
                <section className='grid grid-cols-3 my-4 justify-items-center'>
                    <BlogCard title="Nến thơm là gì, cách nhận biết nến thơm an toàn." image={Blog_1} />  
                    <BlogCard title="Bí quyết cho một giấc ngủ sâu và ngon." image={Blog_2} />
                    <BlogCard title="Tác dụng của nến thơm, các lưu ý khi sử dụng." image={Blog_3} />
                    <BlogCard title="Những thời điểm thích hợp để thắp nến thơm" image={Blog_4} />
                    <BlogCard title="Những ảnh hưởng của mùi hương lên não bộ" image={Blog_5} />
                    <BlogCard title="Những việc làm cho ngày cuối tuần ý nghĩa hơn" image={Blog_6} />
                    {/* Pagination */}
